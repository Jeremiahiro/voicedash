    ...
    <div class="main-panel">
        <div class="content-wrapper">
            <div class="page-header">
                <h1 class="f-28 page-title text-primary font-weight-bolder">List of Images</h1>
            </div>
                        ...
                        <div class="clearfix">
                            <div class="my-3 row grid-margin">
                                <div class="col-md-6 mx-auto">
                                    <p class="text-center">Select Thumbnail</p>
                                    ...
                                    <div class="text-center">
                                        <button class="btn btn-gradient-primary btn-rounded btn-lg m-1">Upload Thumbnail</button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row grid-margin stretch-card">
                <div class="card">
                    <div class="card-body bg-gradient-light">
                        <div class="clearfix">
                            <h4 class="card-title float-left">Recent Images</h4>
